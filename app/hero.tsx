    ...
    <section className=" container relative mx-auto max-w-xl px-4 md:max-w-2xl lg:max-w-4xl    ">
      <div className=" mx-auto flex flex-col justify-between md:flex-row">
        <div className="mr-2 pb-5 text-gray-500 lg:mr-4">
          <h6 className="subheader margin-bottom-8 text-xs font-semibold">Hi, nice to meet you!</h6>
          <h1 className="mb-4 text-4xl font-bold text-gray-700">I'm Jaeheon Kim</h1>
          ...
          <Link className="btn-primary group py-4 font-bold text-emerald-700" href={'/about'}>
            Get to know me
            <ArrowRightSolid
              width={16}
